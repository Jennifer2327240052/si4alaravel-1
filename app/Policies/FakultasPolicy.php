...
class FakultasPolicy
{
    ...
    {
        return $user->role == 'admin' or $user->role == 'dosen'; //hanya admin yang diizinkan untuk update fakultas
    }
    ...
    {
        return $user->role == 'admin'; //hanya admin yang diizinkan untuk update fakultas
    }
